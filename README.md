...
- **💬 Interactive Ink CLI** - Terminal-based chat interface with AI-powered MCP tool discovery. Supports AWS Bedrock and Anthropic API. [Ink CLI Guide](docs/ink-cli-comprehensive-guide.md)
